            ...
            <div class="panel-top">
                <div class="panel-top-left">
                    <div class="fingernail-wrap">
                        ...
                        <div class="fingernail bg5">
                            <div class="fingernail-top">
                                {{ fingernailData.mursing_ratio }}
                            </div>
                            <div class="fingernail-bottom">看护比</div>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    created(){
        let {people_count, nursing_count, bed_count, rate, mursing_ratio} = box1;
...
.fingernail.bg5 {
    background: url("~@/static/Cut-diagram/kanhub.png");
    background-size: 1.275rem 1.3rem;
    background-repeat: no-repeat;
}
